...
export default () => (
  <div className="sign-pledge-container">
    <p>Town Hall Project invites every candidate running for office this year to take the #TownHallPledge to the people of their district or state. This simple commitment of a minimum of four town halls per year is a clear way to say: "I will always listen to the people I work for."</p>
